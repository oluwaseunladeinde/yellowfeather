...
from feather.models import ListingImage, AttributeListing, Listing, Location, Agent, \
    Deal, Attribute
from feather.templatetags.extra_functions import currency
from feather.utils import validate_attribute_value, copy_model_instance, import_validator
...
class ListingAdmin(admin.ModelAdmin):
    change_form_template = "admin/feather/listing/change_form.html"
    fieldsets = [
